...
function obtenerDatos() {
    ...
    if (bError == true) {
        ...
        let respuesta = registrarGrupo(nNumeroGrupo, nNumeroLaboratorio, sNombreProfesor, nNumeroEstudiantes, sHorarioDomingo, sHorarioLunes, sHorarioMartes, sHorarioMiercoles, sHorarioJueves, sHorarioViernes, sHorarioSabado, sHorarioVirtual, sTiempoEntrada, sTiempoSalida);
