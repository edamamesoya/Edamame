...
function registrarGrupo(pNumeroGrupo, pNumeroLaboratorio, pNombreProfesor, pNumeroEstudiantes, pHorarioDomingo, pHorarioLunes, pHorarioMartes, pHorarioMiercoles, pHorarioJueves, pHorarioViernes, pHorarioSabado, pHorarioVirtual, pTiempoEntrada, pTiempoSalida) {
    let respuesta = '';
    let peticion = $.ajax({
